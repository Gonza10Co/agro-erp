...
- [ ] **Cumplimiento DIARIO de la meta mensual** (JP 07-29) — la meta ya es mensual y por célula;
  falta que la fila diaria del reporte muestre si el día va en ritmo (meta prorrateada + `%`).
  Bloqueado por un dato: **no hay calendario de días hábiles**, y dividir por días calendario
  daría un objetivo diario falso. Preguntar a JP si trabajan sábados.
